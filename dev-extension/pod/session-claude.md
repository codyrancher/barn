...
The tree is not a checkout and nothing syncs back. Its repo copy lives in the magic-closet repo
at `rancher-extension/dev-extension/`, which is what a fresh pod is seeded from, so a change
