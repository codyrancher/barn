 ...
 *
 * Repeated here rather than imported from the magic-closet extension that creates it, because
 ...
 * there.
 */
export const DEV_POD_NAMESPACE = 'magic-closet';
export const DEV_POD_LABELS = { app: 'magic-closet-dev-extension' };
 ...
 * magic-closet extension uses `editor`, so anything not called that is a session of its own.
