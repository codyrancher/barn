...
// rancher-extension/dev-extension/, which is a whole dashboard with the
...
const DEV_NS = 'magic-closet';
const DEV_NAME = 'magic-closet-dev-extension';
const DEV_PORT = 8005;
...
const HOST_CACHE_PATH = '/var/lib/rancher/magic-closet/dev-extension';
