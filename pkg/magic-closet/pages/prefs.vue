...
// Magic Closet" checkbox to the END of the Advanced Features section WITHOUT
  ...
  <div class="magic-closet-prefs">
    ...
    >
      <Checkbox
        ...
        tooltip="Show the Magic Closet navigation (Closets, Secret Sets) in the cluster explorer. Reloads to apply."
        class="mt-20"
      />
    </Teleport>
  </div>
