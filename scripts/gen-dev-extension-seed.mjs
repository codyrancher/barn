// Bakes the DevExtension source into the magic-closet extension as a seed.
//
...
//   node rancher-extension/scripts/gen-dev-extension-seed.mjs
...
const APP = path.join(here, '..', 'dev-extension');
const OWNER = path.join(here, '..', 'pkg', 'magic-closet', 'dev-extension.ts');
const OUT = path.join(here, '..', 'pkg', 'magic-closet', 'dev-extension-seed.generated.ts');
...
// Source of truth is rancher-extension/dev-extension/. Regenerate with:
//   node rancher-extension/scripts/gen-dev-extension-seed.mjs
